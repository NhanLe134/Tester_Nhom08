              ...
              <div className="flex-1 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-8">
                  <div>
                    ...
                    <input type="number" className="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm focus:ring-1 focus:ring-green-100 outline-none" placeholder="0" {...f('SL_TON')} />
                  </div>
                  <div>
